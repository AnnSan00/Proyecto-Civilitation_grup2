...
// ----------------------------------------------------------------------------------------------------
// BASE HP (Vida) - Añade esto a tu archivo Variables.java
public final int BASE_HP_SWORDSMAN = 400; 
public final int BASE_HP_SPEARMAN = 1000;
public final int BASE_HP_CROSSBOW = 6000;
public final int BASE_HP_CANNON = 8000;

public final int BASE_HP_ARROWTOWER = 2000;
public final int BASE_HP_CATAPULT = 4000;
public final int BASE_HP_ROCKETLAUNCHERTOWER = 10000;

public final int BASE_HP_MAGICIAN = 1500;
public final int BASE_HP_PRIEST = 1500;

public final int MANA_MAGICIAN = 5000; // Para el constructor del mago
public final int MANA_PRIEST = 15000;  // Para el sacerdote
}
